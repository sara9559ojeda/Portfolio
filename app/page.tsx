  ...
  return (
    <main className="text-blue-200 w-auto">
      <dl id="home" className="bg-[url('/img/bgimg.png')] bg-cover bg-center bg-no-repeat h-screen ">
        <nav className="  ml-auto p-3 backdrop-blur-sm bg-opacity-10 flex flex-row text-sky-250 border-b border-sky-200">
        ...
        <section className="grid grid-cols-1 gap-4  sm:grid-cols-2">
          ...
          <dl className="sm:text-left  text-center md:pt-11 sm:my-auto my-auto">
            <p className="text-3xl font-extralight  sm:pt-10 md:pt-0">I'll tell you about me</p> <br />
            <p className="md:w-[80%] pl-3 pr-3 sm:w-[80%] lg:w-[70%] ">I am a software engineer student passionate about creating technological
          ...
          <a href="# " className=" justify-self-center sm:justify-self-end"><br />
      ...
      <dl id="myprojects" className="bg-gradient-to-b from-[#000414] to-sm-D-blue-950  ">
        <h1>MY PROJECTS</h1>
        <p>first</p>
        <p>first</p>
        <p>first</p>
